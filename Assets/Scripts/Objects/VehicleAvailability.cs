...
public class VehicleAvailability : MonoBehaviour, ISavable
{
    ...
    {
        if (stateObject is not VehicleAvailableState) {
            return;
        }
        VehicleAvailableState state = (VehicleAvailableState)stateObject;
    ...
    public object GetState()
    {
        ...
        return new VehicleAvailableState()
        {
